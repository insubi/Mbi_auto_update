...
engine=(current/'dungeon/ScenarioEngine.cs').read_text(encoding='utf-8-sig');old=(baseline/'dungeon/ScenarioEngine.cs').read_text(encoding='utf-8-sig');peaca=(current/'dungeon/PeacaRouteEngine.cs').read_text(encoding='utf-8-sig');main=(current/'MainForm.cs').read_text(encoding='utf-8-sig')
...
oldmain=(baseline/'MainForm.cs').read_text(encoding='utf-8-sig')
...
orig=json.loads((baseline/'abyss/config/scenario.json').read_text(encoding='utf-8-sig'));new=json.loads((current/'abyss/config/scenario.json').read_text(encoding='utf-8-sig'))
...
ui=(current/'MainForm.ReferenceUI.cs').read_text(encoding='utf-8-sig');old_ui=(baseline/'MainForm.ReferenceUI.cs').read_text(encoding='utf-8-sig')
